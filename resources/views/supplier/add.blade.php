...
<div class="container">
  <div class="card">
   <form class="form-horizontal" method="post" id="form" action="{{URL::to('supplier/add')}}">
    <div class="modal-content row">
      <div class="modal-header col-lg-12">
        <h4 class="modal-title">供應商管理 > 新增</h4>
      </div>
      ...
      <div class="modal-body col-lg-12">
        <div class="form-group" >
          ...
          <div class="col-lg-8">
            <div class="fg-line">
              <input type="text" class="form-control input-sm" name="name" placeholder="請輸入供應商名稱">
            </div>
          </div>
        </div>
        <div class="form-group" >
          ...
          <div class="col-lg-8">
            <div class="fg-line">
              <input type="text" class="form-control input-sm"  name="phone" placeholder="聯絡電話">
            </div>
          </div>
        </div>
        <div class="form-group" >
          ...
          <div class="col-lg-8">
            <div class="fg-line">
              <input type="text" class="form-control input-sm"  name="address" placeholder="聯絡地址">
            </div>
          </div>
        </div>
        <div class="form-group" >
            ...
            <div class="col-lg-8">
              <div class="fg-line">
                <input type="text" class="form-control input-sm"  name="cost" placeholder="訂貨單位成本">
              </div>
            </div>
          </div>
      </div>
